...
export default function PetAccessories() {
  ...
  useEffect(() => {
    if (loadingStatus === "loading") {
      axios
        .get("http://localhost:5000/api/products?category=CAT0004") // filter accessories
        .then((res) => {
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-purple-50 to-purple-100 p-6">
      ...
      <div className="relative w-full bg-gradient-to-r from-purple-100 via-purple-200 to-purple-300 rounded-3xl shadow-xl overflow-hidden flex flex-col md:flex-row items-center justify-between px-10 py-12 mb-12">
        ...
        <div className="max-w-lg text-center md:text-left">
          ...
          <h2 className="text-4xl font-extrabold text-gray-900 leading-tight">
            Premium <span className="text-purple-700">Pet Accessories</span>
          </h2>
          <p className="text-gray-700 text-base mt-3">
            Explore collars, leashes, beds, and more essentials 
            designed to keep your pets comfy and stylish.
          </p>
        ...
        <div className="relative mt-8 md:mt-0 flex-1 flex items-center justify-center">
          ...
          <div className="w-[750px] h-54 bg-white rounded-2xl shadow-lg border border-purple-200 flex items-center justify-center overflow-hidden">
            <img
              src="https://fhuoudyottvtaawdswlz.supabase.co/storage/v1/object/public/images/ProductsPage/a-banner02.webp"
      ...
      {loadingStatus === "loading" && (
        <p className="text-center text-purple-600">Loading accessories...</p>
      )}
      {loadingStatus === "error" && (
        <p className="text-center text-red-500">Failed to load accessories.</p>
      )}
