...
const PayConfo = () => {
  ...
  const handleOrderSummary = () => {
    if (paymentResult?.orderId) {
      window.location.href = `/order/${paymentResult.orderId}`;
    }
  };
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            <div className="bg-red-500 text-white p-6 text-center">
              ...
              <p className="text-red-100 mt-2">
                {paymentResult?.message || "Payment system error"}
              </p>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="p-6">
              <div className="bg-yellow-50 border border-yellow-200 p-4 rounded-lg mb-6">
                ...
                <p className="text-yellow-700">
                  Amount to pay:{" "}
                  <strong>LKR {paymentResult?.amount || "0.00"}</strong>
                </p>
              </div>
              ...
              <div className="bg-purple-50 border border-purple-200 p-6 rounded-lg mb-6 text-center">
                ...
                <div className="space-y-2">
                  <p className="text-2xl font-bold text-purple-800">
                    Account: 9535942775533
                  </p>
                  <p className="text-lg text-purple-600">Bank: ABC Bank</p>
                  <p className="text-lg font-bold text-purple-800">
                    Amount: LKR {paymentResult?.amount || "0.00"}
                  </p>
                </div>
                <div className="mt-4 p-4 bg-white rounded border">
                  <p className="text-sm text-gray-600">
                    <strong>Important:</strong> Please use Order ID "
                    {paymentResult?.orderId}" as the transfer reference.
                  </p>
                </div>
              </div>
              <div className="text-center space-x-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              ...
              <div className="bg-blue-50 p-4 rounded-lg">
                ...
                <div className="space-y-1 text-sm">
                  <p>
                    <strong>Name:</strong> {paymentResult?.name}
                  </p>
                  <p>
                    <strong>Email:</strong> {paymentResult?.email}
                  </p>
                  <p>
                    <strong>Phone:</strong> {paymentResult?.phone}
                  </p>
                </div>
              </div>
            </div>
